                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      variant="outline"
                      size="icon"
                      className="rounded-full h-10 w-10 bg-card-foreground text-primary hover:text-black hover:bg-card-foreground transition-all duration-300 border-none group"
                      asChild
                    >
                      <a
                        href={social.url}
